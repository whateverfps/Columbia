(() => {
  ...
  function stageMarkup(){
    ...
    const scenes = {
      enterprise:`<div class="pv-scene pv-enterprise"><div class="pv-building">${'<i class="pv-floor"></i>'.repeat(6)}</div><div class="pv-core"><div><b>CHIEF</b><small>ENTERPRISE INTELLIGENCE</small></div></div><div class="pv-node n1"><b>PROJECT</b><span>Long-lead equipment risk detected</span></div><div class="pv-node n2"><b>FINANCE</b><span>Potential margin exposure quantified</span></div><div class="pv-node n3"><b>PEOPLE</b><span>Field leadership capacity checked</span></div><div class="pv-node n4"><b>EXECUTIVE</b><span>Escalation threshold evaluated</span></div><div class="pv-node n5"><b>PRECON</b><span>Historical procurement pattern found</span></div><div class="pv-node n6"><b>IT + KNOWLEDGE</b><span>Evidence + permissions verified</span></div>${links([[40,48,20,18,15],[57,48,18,-20,-15],[40,53,18,-20,19],[57,54,19,20,18],[48,42,18,-60,0],[49,59,18,60,0]])}<div class="pv-hud" style="left:2%;top:46%;width:230px"><h4>Signal entering Columbia</h4><div class="pv-kpi"><span>Project 318</span><b class="pv-risk">3-week exposure</b></div><div class="pv-kpi"><span>Source confidence</span><b class="pv-good">High</b></div></div><div class="pv-hud" style="right:2%;top:46%;width:250px"><h4>Recommended enterprise response</h4><div class="pv-kpi"><span>Accelerate procurement</span><b class="pv-good">Review</b></div><div class="pv-kpi"><span>Executive escalation</span><b>No</b></div></div></div>`,
